...
music_folder = r'C:\Users\kalma\Documents\python\python\practice 9\music_player\music'
songs = [
    os.path.join(music_folder, "faaah.mp3"),
    os.path.join(music_folder, "Gaia's Vengeance Kill Sounds & Finisher Sounds - SeLFlo.mp3"),
    os.path.join(music_folder, "red-hot-chili-peppers_can-t-stop.mp3"),
    os.path.join(music_folder, "Танк уничтожен.mp3")
]
